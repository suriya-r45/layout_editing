                ...
                <div className="flex flex-col lg:flex-row gap-8 items-center min-h-[600px]">
                  ...
                  <div className="lg:w-2/3 relative">
                    {section.festivalImage ? (
                        ...
                        >
                          ...
                          <div className="absolute bottom-8 left-8 right-8">
                            <div className="max-w-2xl">
                              ...
                              {section.subtitle && (
                                <p 
                                  className="text-xl md:text-2xl text-white/90 italic mb-6 font-light"
                                  style={{ fontFamily: 'Cormorant Garamond, serif' }}
                                >
                                  {section.subtitle}
                                </p>
                      ...
                      <div className="h-96 lg:h-[500px] rounded-3xl bg-gradient-to-br from-amber-100 to-amber-200 flex flex-col justify-center items-center p-12">
                        <h2 
                          className="text-4xl md:text-5xl lg:text-6xl font-light text-amber-900 mb-4 text-center"
                          style={{ fontFamily: 'Cormorant Garamond, serif' }}
                        >
                          {section.title}
                        </h2>
                        {section.subtitle && (
                          <p 
                            className="text-xl md:text-2xl text-amber-800 italic text-center font-light"
                            style={{ fontFamily: 'Cormorant Garamond, serif' }}
                          >
                            {section.subtitle}
                          </p>
                  ...
                  <div className="lg:w-1/3 h-full">
                    ...
                    <div className="mb-8 text-center lg:text-left">
                      <h3 className="text-3xl font-light text-white mb-2" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                        Festive Treasures
                      </h3>
                      <p className="text-white/80 text-lg">styled to perfection!</p>
                    ...
                    <div className="mt-8 text-center">
                      <Button 
                        className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border-2 border-white/40 hover:border-white/60 px-8 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105 shadow-lg" 
                        style={{ fontFamily: 'Cormorant Garamond, serif' }}
