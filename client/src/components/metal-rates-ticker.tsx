...
export function MetalRatesTicker() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-slate-800 via-gray-800 to-slate-900 text-white py-4 overflow-hidden relative shadow-xl border-b-2 border-gray-600 w-full">
        <div className="ticker-scroll whitespace-nowrap w-full">
          <div className="inline-flex items-center space-x-8 w-max">
            ...
            {[...rates, ...rates].map((rate, index) => {
              ...
              return (
                <span key={index} className="text-sm font-bold px-5 py-2 bg-gray-700/70 rounded-full border-2 border-gray-400/50 flex items-center gap-3 shadow-xl shadow-black/30 backdrop-blur-sm text-white">
                  {isIndia && (
                    <span className="flex items-center gap-2">
                      ...
                      <span className="text-xs bg-orange-600 text-white px-2 py-1.5 rounded-md font-bold shadow-md border border-orange-400">INDIA</span>
                    </span>
                  )}
                  {isBahrain && (
                    <span className="flex items-center gap-2">
                      ...
                      <span className="text-xs bg-red-600 text-white px-2 py-1.5 rounded-md font-bold shadow-md border border-red-400">BAHRAIN</span>
                    </span>
                  )}
